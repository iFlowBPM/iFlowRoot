...
public class JCalendar extends JPanel implements PropertyChangeListener {
	...
	public static void main(String[] s) {
		JFrame frame = new JFrame("JCalendar"); //$NON-NLS-1$
	...
	public void propertyChange(PropertyChangeEvent evt) {
		if (calendar != null) {
			...
			if (evt.getPropertyName().equals("day")) { //$NON-NLS-1$
				...
				setCalendar(c, false);
			} else if (evt.getPropertyName().equals("month")) { //$NON-NLS-1$
				c.set(Calendar.MONTH, ((Integer) evt.getNewValue()).intValue());
				setCalendar(c, false);
			} else if (evt.getPropertyName().equals("year")) { //$NON-NLS-1$
	...
	private void setCalendar(Calendar c, boolean update) {
		...
		firePropertyChange("calendar", oldCalendar, calendar); //$NON-NLS-1$
	}
	...
	public void setDate(Date date) {
		...
		firePropertyChange("date", oldDate, date); //$NON-NLS-1$
	}
