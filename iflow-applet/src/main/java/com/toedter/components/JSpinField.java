...
public class JSpinField extends JPanel implements ChangeListener, CaretListener, ActionListener,
	...
	public void setEnabled(boolean enabled) {
		 ...
		 */
		if (!enabled) {
			textField.setBackground(UIManager.getColor("TextField.inactiveBackground")); //$NON-NLS-1$
		}
	}
	...
	public static void main(String[] s) {
		JFrame frame = new JFrame("JSpinField"); //$NON-NLS-1$
