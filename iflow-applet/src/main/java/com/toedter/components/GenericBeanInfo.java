...
public class GenericBeanInfo extends SimpleBeanInfo {
	...
	public GenericBeanInfo(String bean, boolean registerLocaleEditor) {
		try {
			iconColor16 = loadImage("images/" + bean + "Color16.gif"); //$NON-NLS-1$ //$NON-NLS-2$
			iconColor32 = loadImage("images/" + bean + "Color32.gif"); //$NON-NLS-1$ //$NON-NLS-2$
			iconMono16 = loadImage("images/" + bean + "Mono16.gif"); //$NON-NLS-1$ //$NON-NLS-2$
			iconMono32 = loadImage("images/" + bean + "Mono32.gif"); //$NON-NLS-1$ //$NON-NLS-2$
		} catch (RuntimeException e) {
			System.out.println("GenericBeanInfo.GenericBeanInfo(): " + e); //$NON-NLS-1$
		}
