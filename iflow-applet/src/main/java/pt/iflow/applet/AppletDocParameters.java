...
public interface AppletDocParameters {
  public static final String FLOWID_PARAM = "flowid"; //$NON-NLS-1$
  public static final String PID_PARAM = "pid"; //$NON-NLS-1$
  public static final String SUBPID_PARAM = "subpid"; //$NON-NLS-1$
  public static final String DOCID_PARAM = "docid"; //$NON-NLS-1$
  public static final String VARIABLE_PARAM = "variable"; //$NON-NLS-1$
