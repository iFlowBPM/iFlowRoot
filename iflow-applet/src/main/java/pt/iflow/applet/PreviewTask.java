...
public class PreviewTask extends SwingWorker<Object, Object> implements AppletDocParameters {

  private static Log log = LogFactory.getLog(PreviewTask.class);
  ...
  private PreviewerDialog dialog;
  ...
  public PreviewTask(PreviewerDialog dialog) {
    this.dialog = dialog;
  }
