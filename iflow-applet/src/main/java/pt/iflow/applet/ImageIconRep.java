 ...
 */
public class ImageIconRep implements Icon, Serializable, Accessible {
	...
	static final long serialVersionUID = 522612268326021724L;
     ...
     */
    public ImageIconRep(String filename, String description) {
     ...
     * @see #getDescription
     */
    public ImageIconRep (String filename) {
        this(filename, filename);
    }
     ...
     * @see #ImageIcon(String)
     */
    public ImageIconRep(URL location, String description) {
     ...
     * @see #getDescription
     */
    public ImageIconRep (URL location) {
     ...
     * @param description a brief textual description of the image
     */
    public ImageIconRep(Image image, String description) {
        this(image);
        this.description = description;
    }
     ...
     */
    public ImageIconRep (Image image) {
	this.image = image;
     ...
     */
    public ImageIconRep (byte[] imageData, String description) {
     ...
     * @see java.awt.Image#getProperty
     */
    public ImageIconRep (byte[] imageData) {
	this.image = Toolkit.getDefaultToolkit().createImage(imageData);
        if (image == null) {
            return;
        }
	 ...
	 */
    	...
    	static final long serialVersionUID = 522612268326021725L;
	...
	public String getAccessibleIconDescription() {
	    return ImageIconRep.this.getDescription();
	}
	...
	public void setAccessibleIconDescription(String description) {
		ImageIconRep.this.setDescription(description);
	}
	...
	public int getAccessibleIconHeight() {
	    return ImageIconRep.this.height;
	}
	...
	public int getAccessibleIconWidth() {
	    return ImageIconRep.this.width;
	}
