...
/**
 * This class implements the Ldap API GetCommercialDirectionsForBank.
 * @author João Lopes (joao.lopes@santander.pt)
 * @version 3.7
 */
public class GetCommercialDirectionsForBank
{
  /**
   * This method returns all the commercial directions.
   * <p>
  ...
  public Vector business(String bank)
  {
    ...
    {
      System.out.println("pt.totta.ldap.api.GetCommercialDirectionsForBank.business: bank is invalid.");
      return null;
    }
    ...
    //String searchString = "(&(objectclass=organizationalunitbank)(marcaorgunit=" + bank + ")(nome=Dir.Com.Particulares*))";
    //String searchString = "(&(objectclass=organizationalunitbank)(marcaorgunit=" + bank + ")(nome=Dir. Dinamizacao Premium*))";
    String searchString = "(&(objectclass=organizationalunitbank)(marcaorgunit=" + bank + ")(|(nome=DCom.Particul.*)(nome=DCom.Premium*)))";
    ...
    try
    {
      ...
      while(results.hasMore())
      {
        ...
        String idpai = (String)((Attribute)attributes.get("id")).get();
        String searchString2 = "(&(objectclass=organizationalunitbank)(idpai=" + idpai + "))";
        NamingEnumeration results2 = ldap.searchDirectory(dirContext, searchControls, searchString2, searchBase);
        ...
        if(results2.hasMore()) {
	        ...
	        if(attributes == null)
	        {
	          System.out.println("pt.totta.ldap.api.GetCommercialDirectionsForBank.business: result has no attributes.");
	          return null;
	        }
	        ...
	        {
	         System.out.println("pt.totta.ldap.api.GetCommercialDirectionsForBank.business: unable to fill organizationalunit info.");
	          return null;
	        }
      ...
      if(resultsFound == 0)
      {
        System.out.println("pt.totta.ldap.api.GetCommercialDirectionsForBank.business: no results match the search criteria.");
        return null;
      }
    }
    catch(NamingException e)
    {
      System.out.println("pt.totta.ldap.api.GetCommercialDirectionsForBank.business: " + e.getMessage() + ".");
      return null;
    }
  ...
  public static void main(String args[])
  {
    ...
    System.out.println("");
    System.out.println("GetCommercialDirectionsForBank Test");
    System.out.println("-----------------------------------");
    System.out.println("");
    ...
    // GetCommercialDirectionsForBank test.
    GetCommercialDirectionsForBank getCommercialDirectionsForBank = new GetCommercialDirectionsForBank();
    resultsVector = getCommercialDirectionsForBank.business(bank);
