...
/**
 * This class implements the Ldap API GetUsersInProfile.
 * @author João Lopes (joao.lopes@santander.pt)
 * @version 3.7
 */
public class GetUsersInProfile
{
  /**
  ...
  public static void main(String args[])
  {
    ...
    System.out.println("");
    System.out.println("GetUsersInProfile Test");
    System.out.println("----------------------");
    System.out.println("");
    ...
    GetUsersInProfile getUsersInProfile = new GetUsersInProfile();
    resultsVector = getUsersInProfile.business(applicationName, profile);
