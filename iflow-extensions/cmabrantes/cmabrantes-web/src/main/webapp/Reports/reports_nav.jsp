...
<% if(BeanFactory.getFlowHolderBean().listFlowsOnline(userInfo, FlowType.REPORTS).length > 0){//show reports_personalized%>
	...
	<ul id="reports_personalized_section_body">
		<form name="reports_personalized_section_form" method="post">
			<%
				...
				FlowMenu flows = BeanFactory.getFlowApplicationsBean().getAllApplicationOnlineMenu(userInfo,FlowType.REPORTS);
