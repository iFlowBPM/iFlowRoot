...
public class Type implements java.io.Serializable {
    ...
    public static final java.lang.String _Assiduity = "Assiduity";
    public static final Type _blank_ = new Type(__blank_);
    public static final Type Assiduity = new Type(_Assiduity);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:microsoft-dynamics-schemas/page/ws_registo_assiduidade", "Type"));
    }
    /**
