...
function Lightbox() {
  ...
  function repositionControls() {
    if (CTX.opt.responsive && nextBtn && prevBtn) {
      var btnTop = (window.parent.pageYOffset || (document.documentElement || document.body.parentNode || document.body).scrollTop) + (nextBtn.offsetHeight);// (getHeight() / 2) - (nextBtn.offsetHeight / 2);
  ...
  CTX.resize = function () {
    ...
    currImage.img.setAttribute('style', 'margin-top:' + (window.parent.pageYOffset || (document.documentElement || document.body.parentNode || document.body).scrollTop) + 'px');
