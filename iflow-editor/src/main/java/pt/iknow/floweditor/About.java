...
public class About extends JDialog implements ActionListener {
  ...
  private void jbInit() throws Exception {
    ...
    label1.setText(Mesg.Aboutproduct);
    label2.setText(Mesg.Aboutversion);
    label3.setText(Mesg.Aboutcopyright);
    label4.setText(Mesg.Aboutcomments);
