 ...
 * @see JSPFieldData
 */
public  class JSPTextLabelData extends JSPFieldData {


  // id constructor
  public JSPTextLabelData(FlowEditorAdapter adapter, int anID) {
    super(adapter, anID);
  }

  // simple constructor
  public JSPTextLabelData(FlowEditorAdapter adapter) {
    this(adapter, -1);
  }
  ...
  public JSPTextLabelData(JSPFieldData afdData) {
    super(afdData);
  }
  ...
  protected void init() {
    this._nFieldType = JSPFieldTypeEnum.FIELD_TYPE_TEXT_LABEL;
