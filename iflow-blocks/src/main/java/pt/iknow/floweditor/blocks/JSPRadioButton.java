 ...
 * @see JSPFieldData
 */
public  class JSPRadioButton extends JSPFieldData {


  // id constructor
  public JSPRadioButton(FlowEditorAdapter adapter, int anID) {
    super(adapter, anID);
  }

  // simple constructor
  public JSPRadioButton(FlowEditorAdapter adapter) {
    this(adapter, -1);
  }
  ...
  public JSPRadioButton(JSPFieldData afdData) {
    super(afdData);
  }
  ...
  protected void init() {
    this._nFieldType = JSPFieldTypeEnum.FIELD_TYPE_RADIOBUTTON;
