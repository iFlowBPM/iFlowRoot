...
public class AlteraAtributosFormTemplate extends AbstractAlteraAtributos implements AlteraAtributosInterface {
  ...
  public AlteraAtributosFormTemplate(FlowEditorAdapter adapter) {
    super(adapter, true);
  ...
  private class JTableJSP extends JPanel {
    ...
    AlteraAtributosFormTemplate _parent = null;
    ...
    public JTableJSP(String[] asaColNames, List<Atributo> alAttributes) {
      ...
      this.setBackground(AlteraAtributosFormTemplate.cBG_COLOR);
    ...
    public String[][] exportData() {
      ...
      ret[alNames.size() + 6][0] = AlteraAtributosFormTemplate.sAPPEND_DOCS_VAR;
    ...
    public void importData(List<Atributo> lAttributes) {
      ...
      for (int i=0;i<lAttributes.size(); i++) {
        ...
        if (sName.equals(AlteraAtributos.sDESCRIPTION)) {
          ...
          continue;
        } else if (sName.equals(AlteraAtributosFormTemplate.sAPPEND_DOCS_VAR)) {
    ...
    private void makeTable() {
      ...
      jPanel.setBackground(AlteraAtributosFormTemplate.cBG_COLOR);
      JLabel jLabel = null;
...
// // RESULT
      ...
      this._mainPanel.setBackground(AlteraAtributosFormTemplate.cBG_COLOR);
      ...
      this._fullPanel.setBackground(AlteraAtributosFormTemplate.cBG_COLOR);
        ...
        if (stmp == null) {
          ...
          if (hsEDITABLE_TABLE_COL.contains(col)) {
            ...
            this.makeButton(formatLabel(stmp),
                AlteraAtributosFormTemplate.sROW_EDIT_PREFIX
                + anPosition);
          }
        }
      } // for
    ...
    private void makeSeparator(int anWidth,
      ...
      panel.setBackground(AlteraAtributosFormTemplate.cBG_COLOR);
    ...
    private JLabel makeLabel(String asName,
      ...
      label.setBackground(AlteraAtributosFormTemplate.cBG_COLOR);
      if (afFont != null) {
    ...
    private JButton makeButton(String asName,
      ...
      button.setBackground(AlteraAtributosFormTemplate.cBG_COLOR);
      ...
      button.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(ActionEvent e) {
          ...
          String sRowPos =
            sActionCom
            .substring(AlteraAtributosFormTemplate.sROW_EDIT_PREFIX.length());
    ...
    private JPanel makeControlPanel(int anPosition) {
      ...
      ret.setBackground(AlteraAtributosFormTemplate.cBG_COLOR);
      ...
      JButton jbUp =
        this.makeControlButton("up.gif", //$NON-NLS-1$
            ...
            AlteraAtributosFormTemplate.sROW_MOVE_UP,
            anPosition,
            dimButton);
      if (anPosition == 0) {
      ...
      JButton jbDown =
        this.makeControlButton("down.gif", //$NON-NLS-1$
            ...
            AlteraAtributosFormTemplate.sROW_MOVE_DOWN,
            anPosition,
            dimButton);
      ...
      JButton jbRemove =
        this.makeControlButton("remove.gif", //$NON-NLS-1$
            ...
            AlteraAtributosFormTemplate.sROW_REMOVE,
            anPosition,
            dimButton);
      ...
      JButton jbAdd =
        this.makeControlButton("add.gif", //$NON-NLS-1$
            ...
            AlteraAtributosFormTemplate.sROW_ADD_AT,
            anPosition,
            dimButton);
    ...
    private JButton makeControlButton(String asImageIconName,
      ...
      ret.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(ActionEvent e) {
          ...
          if (asActionCommandPrefix.equals(AlteraAtributosFormTemplate.sROW_MOVE_UP)) {
            sRowPos = sActionCom.substring(AlteraAtributosFormTemplate.sROW_MOVE_UP.length());
            upRow(Integer.parseInt(sRowPos));
          }
          else if (asActionCommandPrefix.equals(AlteraAtributosFormTemplate.sROW_MOVE_DOWN)) {
            sRowPos = sActionCom.substring(AlteraAtributosFormTemplate.sROW_MOVE_DOWN.length());
            downRow(Integer.parseInt(sRowPos));
          }
          else if (asActionCommandPrefix.equals(AlteraAtributosFormTemplate.sROW_REMOVE)) {
            sRowPos = sActionCom.substring(AlteraAtributosFormTemplate.sROW_REMOVE.length());
            removeRow(Integer.parseInt(sRowPos));
          }
          else if (asActionCommandPrefix.equals(AlteraAtributosFormTemplate.sROW_ADD_AT)) {
            sRowPos = sActionCom.substring(AlteraAtributosFormTemplate.sROW_ADD_AT.length());
            addRowAt(Integer.parseInt(sRowPos));
          }
          else if (asActionCommandPrefix.equals(AlteraAtributosFormTemplate.sROW_EDIT_PREFIX)) {
            sRowPos = sActionCom.substring(AlteraAtributosFormTemplate.sROW_EDIT_PREFIX.length());
            editRow(Integer.parseInt(sRowPos),false);
          }
        }
      });
    ...
    public void setParent (AlteraAtributosFormTemplate aParent) {
  ...
  private class JPreviewFormButtons extends JPanel {
    ...
    public JPreviewFormButtons(AlteraAtributosFormTemplate aParent, List<Atributo> alAttributes) {
      super(new BorderLayout());
  ...
  private class FormButton extends JPanel {
    ...
    public void make(boolean abFirst, boolean abLast) {
      ...
      this._jbMoveLeft = this.makeButton("left.gif", null, getAdapter().getString("AlteraAtributosJSP.button.move_button_left"), //$NON-NLS-1$ //$NON-NLS-2$
          AlteraAtributosFormTemplate.sBUTTON_MOVE_LEFT, dBig);
      if (abFirst) {
      ...
      this._jbAdd = this.makeButton("addButton.gif", null, getAdapter().getString("AlteraAtributosJSP.button.add_button"), //$NON-NLS-1$ //$NON-NLS-2$
          AlteraAtributosFormTemplate.sBUTTON_ADD_AT, dSmall);
      ...
      this._jbMoveRight = this.makeButton("right.gif", null, getAdapter().getString("AlteraAtributosJSP.button.move_button_right"), //$NON-NLS-1$ //$NON-NLS-2$
          AlteraAtributosFormTemplate.sBUTTON_MOVE_RIGHT, dBig);
      if (abLast) {
      ...
      this._jbRemove = this.makeButton("removeButton.gif", null, getAdapter().getString("AlteraAtributosJSP.button.remove_button"), //$NON-NLS-1$ //$NON-NLS-2$
          AlteraAtributosFormTemplate.sBUTTON_REMOVE, dSmall);
      if (this.isRequired()) {
      ...
      this._jbText = this.makeButton(null, this.getText(), getAdapter().getString("AlteraAtributosJSP.button.edit_button"), //$NON-NLS-1$
          AlteraAtributosFormTemplate.sBUTTON_EDIT_PREFIX,null);
      ...
      ret.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(ActionEvent e) {
          ...
          if (asActionCommandPrefix
              .equals(AlteraAtributosFormTemplate.sBUTTON_MOVE_RIGHT)) {
            sButtonPos = sActionCom
            .substring(AlteraAtributosFormTemplate.sBUTTON_MOVE_RIGHT.length());
            _parent.rightFormButton(Integer.parseInt(sButtonPos));
          }
          else if (asActionCommandPrefix
              .equals(AlteraAtributosFormTemplate.sBUTTON_MOVE_LEFT)) {
            sButtonPos = sActionCom
            .substring(AlteraAtributosFormTemplate.sBUTTON_MOVE_LEFT.length());
            _parent.leftFormButton(Integer.parseInt(sButtonPos));
          }
          else if (asActionCommandPrefix
              .equals(AlteraAtributosFormTemplate.sBUTTON_REMOVE)) {
            sButtonPos = sActionCom
            .substring(AlteraAtributosFormTemplate.sBUTTON_REMOVE.length());
            _parent.removeFormButton(Integer.parseInt(sButtonPos));
          }
          else if (asActionCommandPrefix
              .equals(AlteraAtributosFormTemplate.sBUTTON_ADD_AT)) {
            sButtonPos = sActionCom
            .substring(AlteraAtributosFormTemplate.sBUTTON_ADD_AT.length());
            _parent.addFormButtonAt(Integer.parseInt(sButtonPos));
          }
          else if (asActionCommandPrefix
              .equals(AlteraAtributosFormTemplate.sBUTTON_EDIT_PREFIX)) {
            sButtonPos = sActionCom
            .substring(AlteraAtributosFormTemplate.sBUTTON_EDIT_PREFIX.length());
