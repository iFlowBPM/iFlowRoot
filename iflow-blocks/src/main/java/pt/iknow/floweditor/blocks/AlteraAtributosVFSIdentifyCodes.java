...
public class AlteraAtributosVFSIdentifyCodes extends AbstractAlteraAtributos implements AlteraAtributosInterface {
  ...
  private final String sDESC_DOCS = adapter.getString("AlteraAtributosVFSIdentifyCodes.seriallist");
  private final String sDESC_TOSIGN = adapter.getString("AlteraAtributosVFSIdentifyCodes.templatelist");
  private final String sATTR_SLIST = "serialList";
  private final String sATTR_TLIST = "templateList";
  /**
   * getExitStatus
   * @return
   */
  ...
  public String[][] getNewAttributes() {
    ...
    newAttributes[0][0] = sATTR_SLIST;
    newAttributes[0][1] = (String) data[0][1];   
    newAttributes[1][0] = sATTR_TLIST;
  ...
  public AlteraAtributosVFSIdentifyCodes(FlowEditorAdapter adapter) {
    super(adapter, adapter.getString("AlteraAtributosVFSIdentifyCodes.title"), true);
    columnNames = new String[] { "-", adapter.getString("AlteraAtributosDocumentToSign.vars") };
  }
