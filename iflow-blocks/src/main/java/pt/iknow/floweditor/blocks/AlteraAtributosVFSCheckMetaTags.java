...
public class AlteraAtributosVFSCheckMetaTags extends AbstractAlteraAtributos implements AlteraAtributosInterface {
  ...
  private final String sDESC_DOCS = adapter.getString("AlteraAtributosVFSCheckMetaTags.mark");
  ...
  public AlteraAtributosVFSCheckMetaTags(FlowEditorAdapter adapter) {
    super(adapter, adapter.getString("AlteraAtributosVFSCheckMetaTags.title"), true);
    columnNames = new String[] { " - ", adapter.getString("AlteraAtributosVFSCheckMetaTags.vars") };
  }
