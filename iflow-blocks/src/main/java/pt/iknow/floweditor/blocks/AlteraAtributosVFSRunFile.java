...
public class AlteraAtributosVFSRunFile extends AbstractAlteraAtributos implements AlteraAtributosInterface {
  ...
  private final String sDESC_DOCS = adapter.getString("AlteraAtributosVFSRunFile.name");
  ...
  public AlteraAtributosVFSRunFile(FlowEditorAdapter adapter) {
    super(adapter, adapter.getString("AlteraAtributosVFSRunFile.title"), true);
    columnNames = new String[] { "-", adapter.getString("AlteraAtributosVFSRunFile.vars") };
  }
