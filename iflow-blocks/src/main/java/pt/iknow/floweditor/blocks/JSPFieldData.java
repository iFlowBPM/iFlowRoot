...
/**
 * Class that contains the jsp field data Should not be used directly...
 */
public class JSPFieldData {
	...
	public final static int nPROP_FIELD_TYPE_CODE = 7; // used only for
														// output/export(not
														// imported)
	...
	public final static int nPROP_DATA_TYPE_CLASS = 13; // used only for
														// output/export(not
														// imported)
	public final static int nPROP_STYLESHEET = 14;
	public final static int nPROP_ALIGNMENT_CODE = 15; // used only for
														// output/export(not
														// imported)
	...
	public final static int nPROP_DATE_FORMAT_ID = 35; // used only for
														// output/export(not
														// imported)
	...
	public final static int nPROP_CHART_TEMPLATE_CODE = 66; // used only for
															// output/export(not
															// imported)
	...
	public final static int nPROP_HOUR_FORMAT_ID = 99; // used only for
														// output/export(not
														// imported)
	...
	// date formats
	protected final static String[] _saDateFormats = { sDATE_FORMAT_NONE, sDATE_FORMAT1, sDATE_FORMAT2, sDATE_FORMAT3,
			sDATE_FORMAT4 };
	protected final static HashMap<String, String> _hmDateFormatCodes = new HashMap<String, String>();

	// hour formats
	protected static String[] _saHourFormats = { sHOUR_FORMAT_NONE, sHOUR_FORMAT1, sHOUR_FORMAT2, sHOUR_FORMAT3 };
	protected final static HashMap<String, String> _hmHourFormatCodes = new HashMap<String, String>();

	// file permissions
	protected final static String[] _saFilePermissions = { "public", "organization", "flow", "process", };
	...
	synchronized static void initMaps(FlowEditorAdapter adapter) {
		...
		_saFilePermissionsDesc = new String[] { adapter.getString("JSPFieldData.proplabel.file_permissions.public"), //$NON-NLS-1$
		...
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_FIELD_TYPE), "fieldtype"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_FIELD_TYPE_CODE), "type"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_TEXT), "text"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_DATA_TYPE), "editordatatype"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_DATA_TYPE_CLASS), "datatype"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_VAR_NAME), "variable"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_SIZE), "size"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_MAXLENGTH), "maxlength"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_TITLE), "title"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_ALIGNMENT), "alignment"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_ALIGNMENT_CODE), "align"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_COLUMN), "column"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_ID), "ID"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_VALUE), "value"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_STYLESHEET), "stylesheet"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_COLS), "cols"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_ROWS), "rows"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_OUTPUT_ONLY), "output_only"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_EMPTY_NOT_ALLOWED), "empty_not_allowed"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_EXTRA_PROPS), "extra_props"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_SERVICE_PRINT), "service_print"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_SERVICE_EXPORT), "service_export"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_CSS_CLASS), "css_class"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_ONCLICK), "onclick"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_ONMOUSE_OVER_STATUS), "onmouse_over_status"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_CONTROL_VAR), "control_var"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_CONTROL_ON_COND), "control_on_cond"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_PROC_LINK), "proc_link"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_URL), "url"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_VAR_VALUE), "var_value"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_OPEN_NEW_WINDOW), "open_new_window"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_WINDOW_NAME), "window_name"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_ONCHANGE_SUBMIT), FormProps.sONCHANGE_SUBMIT); // $NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_DATE_FORMAT), "date_format"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_DATE_FORMAT_ID), "date_format_id"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_DEFAULT_VALUE), "default_value"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_DEFAULT_TEXT), "default_text"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_QUERY), "query"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_DATASOURCE), "datasource"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_CLASSE), "classe"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_ARGS), "args"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_CONNECTOR_SELECT), "connector_select"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_TEXT_VALUE), "text_value"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_VALUE_KEY), "value_key"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_TEXT_KEY), "text_key"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_DISABLE_COND), "disabled_cond"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_OBLIGATORY_FIELD), FormProps.sOBLIGATORY_FIELD); // $NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_VALIDATION_EXPR), "validation_expr"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_VALIDATION_MSG), "validation_msg"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_MACRO_TITLE), "macrotitle"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_ROW_CONTROL_LIST), "rowcontrollist"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_ALT_TEXT), "alt_text"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_WIDTH), "width"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_HEIGHT), "height"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_LINK_COND), "link_cond"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_LINK_TEXT), "link_text"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_LINK_LABEL), "link_label"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_EDIT_COND), "edition_cond"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_EDIT_LABEL), "edition_label"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_REMOVE_COND), "remove_cond"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_REMOVE_LABEL), "remove_label"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_FILE_LABEL), "file_label"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_CURRDATE_IF_EMPTY), "currdate_ifempty"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_TEXT_AREA), "text_area"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_CHART_TEMPLATE), "chart_template"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_CHART_TEMPLATE_CODE), "chart_template_code"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_CHART_TITLE), "chart_title"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_CHART_DSV), "chart_dsv"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_CHART_DSL), "chart_dsl"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_CHART_WIDTH), "chart_width"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_CHART_HEIGHT), "chart_height"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_TABLE_SIZE), "results_per_page"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_USE_LINKS), "use_links"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_PP_RESULT_ARRAY), "pp_result_array"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_PP_PREFETCH), "pp_prefetch"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_PP_PASS_TO_LINK), "pp_pass_link"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_FILE_UPLOAD_LIMIT), "file_upload_limit"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_FILE_UPLOAD_LABEL), "file_upload_label"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_FILE_UPLOAD_COND), "file_upload_cond"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_FILE_UPLOAD_VALID_EXTENSIONS),
				"file_upload_valid_extensions"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_FILE_SCANNER_COND), "file_scanner_cond"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_FILE_PERMISSION), "file_permission"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_FILE_SIGNATURE_TYPE), "file_signature_type"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_FILE_SIGN_NEW), "file_sign_new"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_FILE_SIGN_METHOD), "file_sign_method"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_FILE_IS_IMAGE), "file_is_image"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_FILE_IS_IMAGE_WIDTH), "file_is_image_width"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_FILE_IS_IMAGE_HEIGHT), "file_is_image_height"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_FILE_SIGN_EXISTING), "file_sign_existing"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_FILE_ENCRYPT_USERS), "file_encrypt_users"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_COL_WIDTH_PERCENT), "col_width"); //$NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_FILE_UPLOAD_RENAME), FormProps.FILE_UPLOAD_RENAME); // $NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_FILE_UPLOAD_EXTENSIONS), FormProps.FILE_UPLOAD_EXTENSIONS); // $NON-NLS-1$
		...
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_DISABLE_TABLE_HEADER), FormProps.DISABLE_TABLE_HEADER);
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_TEXT_SUBMIT_ON_BLUR), FormProps.TEXT_SUBMIT_ON_BLUR);
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_DMS_FOLDER), FormProps.DMS_FOLDER);
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_DMS_TITLES), FormProps.DMS_TITLES);
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_DMS_VARS), FormProps.DMS_VARS);
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_DMS_ALIGN), FormProps.DMS_ALIGN);
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_HOUR_FORMAT), FormProps.HOUR_FORMAT); // $NON-NLS-1$
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_HOUR_FORMAT_ID), FormProps.HOUR_FORMAT_ID); // $NON-NLS-1$
		...
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_BUTTON_IGNORE_FORM_PROCESSING),
				"button_ignore_from_processing");
		_hmPropCodeNames.put(new Integer(JSPFieldData.nPROP_BUTTON_IGNORE_FORM_VALIDATION),
				"button_ignore_from_validation");
		...
		_hmPropLabels.put(new Integer(JSPFieldData.nPROP_TEXT), adapter.getString("JSPFieldData.proplabel.text")); //$NON-NLS-1$
		...
		_hmPropLabels.put(new Integer(JSPFieldData.nPROP_SIZE), adapter.getString("JSPFieldData.proplabel.size")); //$NON-NLS-1$
		_hmPropLabels.put(new Integer(JSPFieldData.nPROP_MAXLENGTH),
				adapter.getString("JSPFieldData.proplabel.maxlength")); //$NON-NLS-1$
		_hmPropLabels.put(new Integer(JSPFieldData.nPROP_TITLE), adapter.getString("JSPFieldData.proplabel.title")); //$NON-NLS-1$
		...
		_hmPropLabels.put(new Integer(JSPFieldData.nPROP_COLUMN), adapter.getString("JSPFieldData.proplabel.column")); //$NON-NLS-1$
		_hmPropLabels.put(new Integer(JSPFieldData.nPROP_ID), adapter.getString("JSPFieldData.proplabel.id")); //$NON-NLS-1$
		_hmPropLabels.put(new Integer(JSPFieldData.nPROP_VALUE), adapter.getString("JSPFieldData.proplabel.value")); //$NON-NLS-1$
		_hmPropLabels.put(new Integer(JSPFieldData.nPROP_STYLESHEET),
				adapter.getString("JSPFieldData.proplabel.stylesheet")); //$NON-NLS-1$
		_hmPropLabels.put(new Integer(JSPFieldData.nPROP_COLS), adapter.getString("JSPFieldData.proplabel.cols")); //$NON-NLS-1$
		_hmPropLabels.put(new Integer(JSPFieldData.nPROP_ROWS), adapter.getString("JSPFieldData.proplabel.rows")); //$NON-NLS-1$
		...
		_hmPropLabels.put(new Integer(JSPFieldData.nPROP_ONCLICK), adapter.getString("JSPFieldData.proplabel.onclick")); //$NON-NLS-1$
		...
		_hmPropLabels.put(new Integer(JSPFieldData.nPROP_URL), adapter.getString("JSPFieldData.proplabel.url")); //$NON-NLS-1$
		...
		_hmPropLabels.put(new Integer(JSPFieldData.nPROP_QUERY), adapter.getString("JSPFieldData.proplabel.query")); //$NON-NLS-1$
		_hmPropLabels.put(new Integer(JSPFieldData.nPROP_DATASOURCE),
				adapter.getString("JSPFieldData.proplabel.datasource")); //$NON-NLS-1$
		_hmPropLabels.put(new Integer(JSPFieldData.nPROP_CLASSE), adapter.getString("JSPFieldData.proplabel.classe")); //$NON-NLS-1$
		_hmPropLabels.put(new Integer(JSPFieldData.nPROP_ARGS), adapter.getString("JSPFieldData.proplabel.args")); //$NON-NLS-1$
		...
		_hmPropLabels.put(new Integer(JSPFieldData.nPROP_TEXT_AREA), ""); //$NON-NLS-1$
		...
		_hmPropLabels.put(new Integer(nPROP_FILE_SIGN_NEW), adapter.getString("JSPFieldData.proplabel.file_sign_new")); // $NON-NLS-1$
		_hmPropLabels.put(new Integer(nPROP_FILE_SIGN_METHOD),
				adapter.getString("JSPFieldData.proplabel.file_sign_method")); // $NON-NLS-1$
		_hmPropLabels.put(new Integer(nPROP_FILE_IS_IMAGE), adapter.getString("JSPFieldData.proplabel.file_is_image")); // $NON-NLS-1$
		...
		_hmPropLabels.put(new Integer(nPROP_COL_WIDTH_PERCENT), adapter.getString("JSPFieldData.proplabel.col_width")); // $NON-NLS-1$
		...
		_hmPropLabels.put(new Integer(nPROP_BUTTON_TYPE), adapter.getString("JSPFieldData.proplabel.button_type"));
		_hmPropLabels.put(new Integer(nPROP_BUTTON_TOOLTIP),
				adapter.getString("JSPFieldData.proplabel.button_tooltip"));
		_hmPropLabels.put(new Integer(nPROP_BUTTON_IMAGE), adapter.getString("JSPFieldData.proplabel.button_image"));
		...
		_hmPropLabels.put(new Integer(JSPFieldData.nPROP_FORM_TEMPLATE),
				adapter.getString("JSPFieldData.proplabel." + FormProps.FORM_TEMPLATE));
		_hmPropLabels.put(new Integer(JSPFieldData.nPROP_KEEP_SCROLL_ONLOAD),
				adapter.getString("JSPFieldData.proplabel." + FormProps.KEEP_SCROLL_ONLOAD));

		// DATA TYPES
		_hmDataTypes.put(new Integer(JSPFieldData.nDATA_TYPE_NONE), JSPFieldData.sCHOOSE);
		_hmDataTypeClasses.put(new Integer(JSPFieldData.nDATA_TYPE_NONE), null);
		...
		// ALIGNMENTS
		_hmAlignments.put(new Integer(JSPFieldData.nALIGNMENT_NONE), JSPFieldData.sCHOOSE);
		_hmAlignments.put(new Integer(JSPFieldData.nALIGNMENT_LEFT), adapter.getString("JSPFieldData.alignments.left")); //$NON-NLS-1$
		...
		_hmAlignmentCodes.put(new Integer(JSPFieldData.nALIGNMENT_NONE), ALIGNMENT_NONE); // $NON-NLS-1$
		_hmAlignmentCodes.put(new Integer(JSPFieldData.nALIGNMENT_LEFT), "left"); //$NON-NLS-1$
		_hmAlignmentCodes.put(new Integer(JSPFieldData.nALIGNMENT_CENTER), "center"); //$NON-NLS-1$
		_hmAlignmentCodes.put(new Integer(JSPFieldData.nALIGNMENT_RIGHT), "right"); //$NON-NLS-1$
		...
		if (adapter.isRepOn()) {
			...
			if (null == repositoryListOfSuportFlows)
				repositoryListOfSuportFlows = new String[0];
	...
	private static void initConnectors(FlowEditorAdapter adapter) {
		...
		// colocar la os connectors (e outras listas estaticas que venham do
		// repositorio)
		// qd se faz switch workspace, limpar a cache, para garantir o
		// carregamento ao ligar a outro repositorio
		...
		try {
			NameValuePair<String, String>[] connectors = ConnectorMarshaller
					.unmarshal(adapter.getRepository().getConnectors());
	...
	public JSPFieldData(FlowEditorAdapter adapter, int anPosition, List<String> aalNames, List<String> aalValues,
		...
		for (int i = 0; i < aalNames.size(); i++) {
			...
			idx = sName.indexOf(JSPFieldData.sROW + JSPFieldData.sJUNCTION);
			if (idx > -1) {
				idx += JSPFieldData.sROW.length() + JSPFieldData.sJUNCTION.length();
				stmp = sName.substring(idx, sName.indexOf(JSPFieldData.sJUNCTION, idx));
				row = Integer.parseInt(stmp);
				idx += stmp.length() + JSPFieldData.sJUNCTION.length();
			...
			case JSPFieldData.nPROP_FIELD_TYPE:
				// Do nothing. Right now field type is fetched from
				// nPROP_FIELD_TYPE_CODE
	...
	public JSPFieldData(JSPFieldData afd) {
		...
		while (iter.hasNext()) {
			...
			else if (iKey == nPROP_FILE_SIGNATURE_TYPE && StringUtils.isNotEmpty(sVal)
					&& getFileSignatureTypeDescMap().get(sVal) != null)
	...
	/**
	 * Basic data copy: copies id, position and table props from existing
	 * object.
	 */
	...
	// set property for multiple field data objects (e.g. table fields)
	public void setProperty(Integer aiListIndex, Integer aiPropID, String asValue) {
		...
		if (aiListIndex == null || aiListIndex.intValue() < 0) {
			...
			if (this._alPropsList.isEmpty() || this._alPropsList.size() <= aiListIndex.intValue()) {
				// initialize lists
	...
	private void removeListProp() {
		...
		if (this._alPropsList.size() == 0 && this._alEditComponentsList.size() == 0) {
			this.addListProp();
		}
	}
	...
	protected synchronized void loadSignatureTypes() {
		if (null != _saFileSignatureTypeDesc)
			return;
	...
	public String[] getChartTemplates() {
		if (null == _hmChartTemplates || 0 == _hmChartTemplates.size())
			loadChartTemplates();
	...
	public JComponent getEditComponent(int anListIndex, int anPropID) {
		return this.getEditComponent(new Integer(anListIndex), new Integer(anPropID));
	}
	...
	public void setEditComponent(Integer aiPropID, JComponent ajcValue) {
		this.setEditComponent(null, aiPropID, ajcValue);

	}

	// set multiple property's edit component
	public void setEditComponent(Integer aiListIndex, Integer aiPropID, JComponent ajcValue) {
	...
	public Map<Integer, ArrayList<String>> exportData() {
		...
		String sPrefix = JSPFieldData.sNAME_PREFIX + JSPFieldData.sJUNCTION + this.getPosition()
		...
		for (int i = 0; i < (this._hmStaticProps.size() + this._alEditSingleProps.size()); i++) {
			...
			try {
				...
				case JSPFieldData.nPROP_CHART_TEMPLATE:
					...
					break;
				case JSPFieldData.nPROP_DATE_FORMAT:
					// set additional fields: size, maxlength and id related to
		...
		for (int row = 0; row < this._alPropsList.size(); row++) {
			...
			sName = sPrefix + JSPFieldData.sROW + JSPFieldData.sJUNCTION + iRow.toString() + JSPFieldData.sJUNCTION;
			...
			for (int i = 0; i < this._alEditMultipleProps.size(); i++) {
				...
				try {
					...
					case JSPFieldData.nPROP_DATA_TYPE:
						// sVal has data type text
						// in this case get the appropriate data type id from
						// text
						// to be able to get data type class name
						iProp2 = new Integer(JSPFieldData.nPROP_DATA_TYPE_CLASS);
					...
					case JSPFieldData.nPROP_CHART_TEMPLATE:
						...
						break;
					case JSPFieldData.nPROP_DATE_FORMAT:
						// set additional fields: size and maxlength related to
						// selected date format
						int ntmp = sVal.length();
						iProp2 = new Integer(JSPFieldData.nPROP_SIZE);
						sVal2 = String.valueOf(ntmp + 4);
	...
	public synchronized JPanel makeEditPanel() {
		...
		for (int i = 0; i < this._alEditSingleProps.size(); i++) {
			...
			case JSPFieldData.nPROP_DATA_TYPE:
				...
				if (stmp.equals("")) //$NON-NLS-1$
					stmp = JSPFieldData.sCHOOSE;
			...
			case JSPFieldData.nPROP_ALIGNMENT:
				...
				if (null == stmp || stmp.equals("")) //$NON-NLS-1$
					stmp = sCHOOSE;
				((JComboBox) jValue).setSelectedItem(stmp);
				break;
			case JSPFieldData.nPROP_CHART_TEMPLATE:
					...
					listofSuportFlowsComboBox.addActionListener(new java.awt.event.ActionListener() {
						public void actionPerformed(ActionEvent e) {
							...
							if (selectedPopupFlow != null && !"".equals(selectedPopupFlow)) {
								String[][] inputFields = JSPPopupFormFieldData.loadPopupvariables(adapter,
										selectedPopupFlow);

								for (int i = 0; i < inputFields.length; i++) {
									HashMap<Integer, String> prop = new HashMap<Integer, String>();
									// prop.put(nPROP_POPUP_VARIABLES,
									// String.valueOf(inputFields[i][0]));
		...
		for (int i = 0; i < this._alEditSingleProps.size(); i++) {
			...
			if (this._hmPropDependencies.containsKey(iProp)) {
				...
				case JSPFieldData.nPROP_BUTTON_CONFIRM_ACTION:
					...
					break;
				case JSPFieldData.nPROP_TEXT_AREA:
					// ((JTextArea)jValue).addDocumentListener(new
					// DependencyTextListener(jValue, pd, altmp, altmp2));
					break;
				case JSPFieldData.nPROP_DATASOURCE:
					// nao sei se eh realmente necessario um listener deste
					// tipo...
					break;
				case JSPFieldData.nPROP_FORM_TEMPLATE:
					// nao sei se eh realmente necessario um listener deste
			...
			for (int i = 0; i < this._alEditMultipleProps.size(); i++) {
				...
				if (i == (this._alEditMultipleProps.size() - 1)) {
					...
					JButton upBtn = this.makeControlButton("up.gif", //$NON-NLS-1$
							...
							new ReorderActionListener(REORDER_UP, row), dimButton);
					...
					JButton dnBtn = this.makeControlButton("down.gif", //$NON-NLS-1$
							...
							new ReorderActionListener(REORDER_DOWN, row), dimButton);
					if (null != sizer) {
						sizer.add(upBtn);
						sizer.add(dnBtn);
						if (null != upBtn)
	...
	private JButton makeControlButton(String asImageIconName, String asToolTipText, ActionListener l,
	...
	public void saveData() throws FieldDataException {
		this.saveData(true);
	}

	@SuppressWarnings("unchecked")
	public void saveData(boolean abValidate) throws FieldDataException {
		...
		for (int i = 0; i < this._alEditSingleProps.size(); i++) {
			...
			if (jValue == null) {
				...
				switch (iProp.intValue()) {
				case JSPFieldData.nPROP_CONNECTOR_SELECT:
					String clazz = ((NameValuePair<String, String>) (((JComboBox) jValue).getSelectedItem()))
							.getValue();
	...
	private void validateData(Integer aiPropID, String asValue) throws FieldDataException {
		this.validateData(null, aiPropID, asValue);
	}

	private void validateData(Integer aiRow, Integer aiPropID, String asValue) throws FieldDataException {
		...
		if (this._hmPropTypes.containsKey(aiPropID)) {
			...
			case JSPFieldData.nCHART_TEMPLATES:
				if (asValue.equals(JSPFieldData.sCHOOSE) && asValue != null) {
					throw new FieldDataException(adapter, aiRow, aiPropID, false);
				}
				break;
	...
	private NameValuePair<String, String> getConnectorItem(String stmp) {
		NameValuePair<String, String> retObj = new NameValuePair<String, String>(sCHOOSE);
	...
	class PropDependency {
		...
		public PropDependency(int anProp, int anValueAction, int anValueType, Object aoValue) {
		...
		public PropDependency(int anProp, int anValueAction, Object aoValue) {
			this(anProp, anValueAction, PropDependency.nUSER_DEFINED, aoValue);
		}

		public PropDependency(int anProp, int anValueAction, int anValueType) {
		...
		public boolean isOn(Object aoValue, boolean abStringValue) {
			...
			try {
				...
				case PropDependency.nUSER_DEFINED:
					// text
					pt.iflow.api.utils.Logger.debug("", this, "",
							"  ==> aoValue: '" + aoValue + "'; _oValue: '" + _oValue + "'");
	...
	class DependencyListener {
		...
		public DependencyListener(JComponent ajc, PropDependency apd, ArrayList<JComponent> aalDependentComponents,
	...
	class DependencyComboListener extends DependencyListener implements ItemListener {

		public DependencyComboListener(JComponent ajc, PropDependency apd, ArrayList<JComponent> aalDependentComponents,
				ArrayList<JLabel> aalDependentComponentLabels) {
	...
	class DependencyCheckListener extends DependencyListener implements ItemListener {

		public DependencyCheckListener(JComponent ajc, PropDependency apd, ArrayList<JComponent> aalDependentComponents,
				ArrayList<JLabel> aalDependentComponentLabels) {
			super(ajc, apd, aalDependentComponents, aalDependentComponentLabels);
		}
	...
	class DependencyTextListener extends DependencyListener implements ActionListener {

		public DependencyTextListener(JComponent ajc, PropDependency apd, ArrayList<JComponent> aalDependentComponents,
				ArrayList<JLabel> aalDependentComponentLabels) {
			super(ajc, apd, aalDependentComponents, aalDependentComponentLabels);
		}
	...
	private class ReorderActionListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent ev) {
			Integer from = position; // java 5 take care of wrapping primitive
										// types
			Integer to = position;
			...
			case REORDER_DOWN:
				to = position + 1;
				if (to >= JSPFieldData.this._alPropsList.size())
					to = JSPFieldData.this._alPropsList.size() - 1;
				break;
			}
			...
			try {
				JSPFieldData.this.saveData(false);
			} catch (Exception e) {
			}
	...
	public void requestSubFlowCatalogVariables(String subFlowName) {
		String[] fieldsColumnNames = new String[] { adapter.getString("AlteraAtributosSubFlow.flowVars"),
