...
public class AlteraAtributosDocumentPreview extends AbstractAlteraAtributos implements AlteraAtributosInterface {
  ...
  public AlteraAtributosDocumentPreview(FlowEditorAdapter adapter) {
    super(adapter, true);
  ...
  private class JTableJSP extends JPanel {
    ...
    AlteraAtributosDocumentPreview _parent = null;
    ...
    public JTableJSP(String[] asaColNames, List<Atributo> alAttributes) {
      ...
      this.setBackground(AlteraAtributosDocumentPreview.cBG_COLOR);
    ...
    public String[][] exportData() {
      ...
      ret[alNames.size() + 6][0] = AlteraAtributosDocumentPreview.sAPPEND_DOCS_VAR;
    ...
    public void importData(List<Atributo> lAttributes) {
      ...
      for (int i=0;i<lAttributes.size(); i++) {
        ...
        if (sName.equals(AlteraAtributos.sDESCRIPTION)) {
          ...
          continue;
        } else if (sName.equals(AlteraAtributosDocumentPreview.sAPPEND_DOCS_VAR)) {
    ...
    private void makeTable() {
      ...
      jPanel.setBackground(AlteraAtributosDocumentPreview.cBG_COLOR);
      JLabel jLabel = null;
      String stmp = getAdapter().getString("AlteraAtributosJSP.disableInput"); //$NON-NLS-1$
      jLabel = new JLabel("               ");
      ...
      sizer.setBackground(AlteraAtributosDocumentPreview.cBG_COLOR);
      sizer.setSize(5,1);
...
// // RESULT
      ...
      // // separator
      // sizer = new JPanel();
      // sizer.setBackground(AlteraAtributosFormTemplate.cBG_COLOR);
      // sizer.setSize(5,1);
      // sGridbag.setConstraints(sizer,sC);
      // jPanel.add(sizer);
      // sC.gridwidth = GridBagConstraints.REMAINDER;
      ...
      // _jcbForwardOnSubmit.setBackground(AlteraAtributosFormTemplate.cBG_COLOR);
      // sC.gridwidth = 1;
      ...
      this._mainPanel.setBackground(AlteraAtributosDocumentPreview.cBG_COLOR);
      ...
      this._fullPanel.setBackground(AlteraAtributosDocumentPreview.cBG_COLOR);
        ...
        if (stmp == null) {
          ...
          if (hsEDITABLE_TABLE_COL.contains(col)) {
            ...
            this.makeButton(formatLabel(stmp),
                AlteraAtributosDocumentPreview.sROW_EDIT_PREFIX
                + anPosition);
          }
        }
      } // for
    ...
    private void makeSeparator(int anWidth,
      ...
      panel.setBackground(AlteraAtributosDocumentPreview.cBG_COLOR);
    ...
    private JLabel makeLabel(String asName,
      ...
      label.setBackground(AlteraAtributosDocumentPreview.cBG_COLOR);
      if (afFont != null) {
    ...
    private JButton makeButton(String asName,
      ...
      button.setBackground(AlteraAtributosDocumentPreview.cBG_COLOR);
      ...
      button.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(ActionEvent e) {
          ...
          String sRowPos =
            sActionCom
            .substring(AlteraAtributosDocumentPreview.sROW_EDIT_PREFIX.length());
    ...
    private JPanel makeControlPanel(int anPosition) {
      ...
      ret.setBackground(AlteraAtributosDocumentPreview.cBG_COLOR);
      ...
      JButton jbUp =
        this.makeControlButton("up.gif", //$NON-NLS-1$
            ...
            AlteraAtributosDocumentPreview.sROW_MOVE_UP,
            anPosition,
            dimButton);
      if (anPosition == 0) {
      ...
      JButton jbDown =
        this.makeControlButton("down.gif", //$NON-NLS-1$
            ...
            AlteraAtributosDocumentPreview.sROW_MOVE_DOWN,
            anPosition,
            dimButton);
      ...
      JButton jbRemove =
        this.makeControlButton("remove.gif", //$NON-NLS-1$
            ...
            AlteraAtributosDocumentPreview.sROW_REMOVE,
            anPosition,
            dimButton);
      ...
      JButton jbAdd =
        this.makeControlButton("add.gif", //$NON-NLS-1$
            ...
            AlteraAtributosDocumentPreview.sROW_ADD_AT,
            anPosition,
            dimButton);
    ...
    private JButton makeControlButton(String asImageIconName,
      ...
      ret.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(ActionEvent e) {
          ...
          if (asActionCommandPrefix.equals(AlteraAtributosDocumentPreview.sROW_MOVE_UP)) {
            sRowPos = sActionCom.substring(AlteraAtributosDocumentPreview.sROW_MOVE_UP.length());
            upRow(Integer.parseInt(sRowPos));
          }
          else if (asActionCommandPrefix.equals(AlteraAtributosDocumentPreview.sROW_MOVE_DOWN)) {
            sRowPos = sActionCom.substring(AlteraAtributosDocumentPreview.sROW_MOVE_DOWN.length());
            downRow(Integer.parseInt(sRowPos));
          }
          else if (asActionCommandPrefix.equals(AlteraAtributosDocumentPreview.sROW_REMOVE)) {
            sRowPos = sActionCom.substring(AlteraAtributosDocumentPreview.sROW_REMOVE.length());
            removeRow(Integer.parseInt(sRowPos));
          }
          else if (asActionCommandPrefix.equals(AlteraAtributosDocumentPreview.sROW_ADD_AT)) {
            sRowPos = sActionCom.substring(AlteraAtributosDocumentPreview.sROW_ADD_AT.length());
            addRowAt(Integer.parseInt(sRowPos));
          }
          else if (asActionCommandPrefix.equals(AlteraAtributosDocumentPreview.sROW_EDIT_PREFIX)) {
            sRowPos = sActionCom.substring(AlteraAtributosDocumentPreview.sROW_EDIT_PREFIX.length());
            editRow(Integer.parseInt(sRowPos),false);
          }
        }
      });
    ...
    public void setParent (AlteraAtributosDocumentPreview aParent) {
  ...
  private class RowEditor extends JDialog {
    ...
    public void init() {
      ...
      // Remove form template from combo
      JSPFieldTypeEnum[] temp = JSPFieldTypeEnum.values();
      JSPFieldTypeEnum[] finalCombo = new JSPFieldTypeEnum[temp.length - 1];
      for (int i = 0, j = 0; i < temp.length; i++)
        if (temp[i] != JSPFieldTypeEnum.FIELD_TYPE_FORM_TEMPLATE)
          finalCombo[j++] = temp[i];

      this.jComboFields = new JComboBox(finalCombo);
  ...
  private class JPreviewFormButtons extends JPanel {
    ...
    public JPreviewFormButtons(AlteraAtributosDocumentPreview aParent, List<Atributo> alAttributes) {
      super(new BorderLayout());
  ...
  private class FormButton extends JPanel {
    ...
    public void make(boolean abFirst, boolean abLast) {
      ...
      this._jbMoveLeft = this.makeButton("left.gif", null, getAdapter().getString("AlteraAtributosJSP.button.move_button_left"), //$NON-NLS-1$ //$NON-NLS-2$
          AlteraAtributosDocumentPreview.sBUTTON_MOVE_LEFT, dBig);
      if (abFirst) {
      ...
      this._jbAdd = this.makeButton("addButton.gif", null, getAdapter().getString("AlteraAtributosJSP.button.add_button"), //$NON-NLS-1$ //$NON-NLS-2$
          AlteraAtributosDocumentPreview.sBUTTON_ADD_AT, dSmall);
      ...
      this._jbMoveRight = this.makeButton("right.gif", null, getAdapter().getString("AlteraAtributosJSP.button.move_button_right"), //$NON-NLS-1$ //$NON-NLS-2$
          AlteraAtributosDocumentPreview.sBUTTON_MOVE_RIGHT, dBig);
      if (abLast) {
      ...
      this._jbRemove = this.makeButton("removeButton.gif", null, getAdapter().getString("AlteraAtributosJSP.button.remove_button"), //$NON-NLS-1$ //$NON-NLS-2$
          AlteraAtributosDocumentPreview.sBUTTON_REMOVE, dSmall);
      if (this.isRequired()) {
      ...
      this._jbText = this.makeButton(null, this.getText(), getAdapter().getString("AlteraAtributosJSP.button.edit_button"), //$NON-NLS-1$
          AlteraAtributosDocumentPreview.sBUTTON_EDIT_PREFIX,null);
      ...
      ret.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(ActionEvent e) {
          ...
          if (asActionCommandPrefix
              .equals(AlteraAtributosDocumentPreview.sBUTTON_MOVE_RIGHT)) {
            sButtonPos = sActionCom
            .substring(AlteraAtributosDocumentPreview.sBUTTON_MOVE_RIGHT.length());
            _parent.rightFormButton(Integer.parseInt(sButtonPos));
          }
          else if (asActionCommandPrefix
              .equals(AlteraAtributosDocumentPreview.sBUTTON_MOVE_LEFT)) {
            sButtonPos = sActionCom
            .substring(AlteraAtributosDocumentPreview.sBUTTON_MOVE_LEFT.length());
            _parent.leftFormButton(Integer.parseInt(sButtonPos));
          }
          else if (asActionCommandPrefix
              .equals(AlteraAtributosDocumentPreview.sBUTTON_REMOVE)) {
            sButtonPos = sActionCom
            .substring(AlteraAtributosDocumentPreview.sBUTTON_REMOVE.length());
            _parent.removeFormButton(Integer.parseInt(sButtonPos));
          }
          else if (asActionCommandPrefix
              .equals(AlteraAtributosDocumentPreview.sBUTTON_ADD_AT)) {
            sButtonPos = sActionCom
            .substring(AlteraAtributosDocumentPreview.sBUTTON_ADD_AT.length());
            _parent.addFormButtonAt(Integer.parseInt(sButtonPos));
          }
          else if (asActionCommandPrefix
              .equals(AlteraAtributosDocumentPreview.sBUTTON_EDIT_PREFIX)) {
            sButtonPos = sActionCom
            .substring(AlteraAtributosDocumentPreview.sBUTTON_EDIT_PREFIX.length());
