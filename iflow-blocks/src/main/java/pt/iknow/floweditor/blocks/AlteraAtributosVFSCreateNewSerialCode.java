...
public class AlteraAtributosVFSCreateNewSerialCode extends AbstractAlteraAtributos implements AlteraAtributosInterface {
  ...
  private final String sDESC_DOCS = adapter.getString("AlteraAtributosVFSGenerateSerialCode.template");
  private final String sDESC_TOSIGN = adapter.getString("AlteraAtributosVFSGenerateSerialCode.serial");
  ...
  public AlteraAtributosVFSCreateNewSerialCode(FlowEditorAdapter adapter) {
    super(adapter, adapter.getString("AlteraAtributosVFSCreateNewSerialCode.title"), true);
