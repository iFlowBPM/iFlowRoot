...
public class AlteraAtributosVFSMarkAsTag extends AbstractAlteraAtributos implements AlteraAtributosInterface {
  ...
  private final String sDESC_DOCS = adapter.getString("AlteraAtributosVFSMarkAsTag.name");
  private final String sDESC_TOSIGN = adapter.getString("AlteraAtributosVFSMarkAsTag.mark");
  private final String sATTR_NAME = "Name";
  ...
  public String[][] getNewAttributes() {
    ...
    newAttributes[0][0] = sATTR_NAME;
    newAttributes[0][1] = (String) data[0][1];   
    newAttributes[1][0] = sATTR_MARK;
  ...
  public AlteraAtributosVFSMarkAsTag(FlowEditorAdapter adapter) {
    super(adapter, adapter.getString("AlteraAtributosVFSMarkAsTag.title"), true);
    columnNames = new String[] { "-", adapter.getString("AlteraAtributosVFSMarkAsTag.vars") };
  }
