...
public class AlteraAtributosVFSGenerateSerialCode extends AbstractAlteraAtributos implements AlteraAtributosInterface {
  ...
  public AlteraAtributosVFSGenerateSerialCode(FlowEditorAdapter adapter) {
    super(adapter, adapter.getString("AlteraAtributosVFSGenerateSerialCode.title"), true);
