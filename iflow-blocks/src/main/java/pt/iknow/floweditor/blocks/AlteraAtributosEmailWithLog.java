...
public class AlteraAtributosEmailWithLog extends AbstractAlteraAtributos implements AlteraAtributosInterface {
  ...
  public final static String sEMAIL_MESSAGE_ID = "messageId"; // for use in email with log
  ...
  public final String sDESC_EMAIL_MESSAGE_ID;

  private int exitStatus = EXIT_STATUS_CANCEL;
  private String[][] data;

  
  public AlteraAtributosEmailWithLog(FlowEditorAdapter adapter) {
    ...
    sDESC_EMAIL_MESSAGE_ID = adapter.getString("AlteraAtributosEmailWithLog.messageId"); //$NON-NLS-1$
  }
  ...
  public String[][] getNewAttributes() {
    ...
    data[0][0] = AlteraAtributosEmailWithLog.sEMAIL_FROM;
    data[1][0] = AlteraAtributosEmailWithLog.sEMAIL_TO;
    data[2][0] = AlteraAtributosEmailWithLog.sEMAIL_SUBJECT;
    data[3][0] = AlteraAtributosEmailWithLog.sEMAIL_MESSAGE;
    data[4][0] = AlteraAtributosEmailWithLog.sEMAIL_TEMPLATE;
    data[5][0] = AlteraAtributosEmailWithLog.sEMAIL_ATTACHMENT;
    data[6][0] = AlteraAtributosEmailWithLog.sEMAIL_ATTACHMENT_COMPRESS;
    data[7][0] = AlteraAtributosEmailWithLog.sEMAIL_CC;
    data[8][0] = AlteraAtributosEmailWithLog.sEMAIL_BCC;
    data[9][0] = AlteraAtributosEmailWithLog.sEMAIL_MESSAGE_ID;
  ...
  public void setDataIn(String title, List<Atributo> atributos) {
    ...
    // BCC
    data[9][0] = sDESC_EMAIL_MESSAGE_ID;
    if (atributos != null && atributos.size() > 9 && atributos.get(9) != null)
      stmp = new String(((Atributo) atributos.get(9)).getValor());
    else
      stmp = null;
    if (stmp == null || stmp.equals("")) //$NON-NLS-1$
      stmp = ""; //$NON-NLS-1$
    data[9][1] = stmp;
    this._jtfMessageId = new JTextField();
    this._jtfMessageId.setText((String) data[9][1]);
    ...
    ed = new DefaultCellEditor(this._jtfMessageId);
    cm.addEditorForCell(9, 1, ed);
  ...
  void jButton1_actionPerformed(ActionEvent e) {
    ...
    // mesageId
    data[9][1] = jTable1.getStringAt(9, 1);
