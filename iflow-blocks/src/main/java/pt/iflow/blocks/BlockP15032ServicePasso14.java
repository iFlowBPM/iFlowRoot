...
public class BlockP15032ServicePasso14 extends BlockP15032OER {

  public BlockP15032ServicePasso14(int anFlowId, int id, int subflowblockid,
			String filename) {
  ...
  public Port after(UserInfoInterface userInfo, ProcessData procData) {
	    ...
	    String sIdVar = getParsedAttribute(userInfo, "Id", procData);	    
	      ...
	      try {	    	  
	    	  ...
	    	  OERResponseData result = tester.runPasso(Config.getOERUsername(), Config.getOERPassword(), asset, 14);
