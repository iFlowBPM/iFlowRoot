...
public class BlockP15032ServicePasso9 extends BlockP15032OER {

  public BlockP15032ServicePasso9(int anFlowId, int id, int subflowblockid,
			String filename) {
...
/**
  ...
  public Port after(UserInfoInterface userInfo, ProcessData procData) {
	    ...
	    String sEndpointVar = getParsedAttribute(userInfo, "Endpoint", procData);
	    	 	    
	      try {	    	  
	    	  com.infosistema.oerrexiflowlib.data.OERAssetServico asset = new OERAssetServico();
	    	  
	    	  asset.setId(Long.parseLong(sIdVar));
	    	  asset.setEndpoint(sEndpointVar);
	    	  
	    	  IflowServicoMain tester = new IflowServicoMain();
	    	  OERResponseData result = tester.runPasso(Config.getOERUsername(), Config.getOERPassword(), asset, 9);
