...
public class BlockP15032ServicePasso3 extends BlockP15032OER {

  public BlockP15032ServicePasso3(int anFlowId, int id, int subflowblockid,
			String filename) {
  ...
  public Port after(UserInfoInterface userInfo, ProcessData procData) {
	    ...
	    ProcessListVariable documentURLListVar = procData.getList(getAttribute("DocumentURLList"));
	      ...
	      try {	    	  
	    	  ...
	    	  OERResponseData result = tester.runPasso(Config.getOERUsername(), Config.getOERPassword(), asset,3);
