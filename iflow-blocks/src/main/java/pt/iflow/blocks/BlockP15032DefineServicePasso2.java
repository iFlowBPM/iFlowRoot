...
public class BlockP15032DefineServicePasso2 extends BlockP15032OER {

  public BlockP15032DefineServicePasso2(int anFlowId, int id, int subflowblockid,
			String filename) {
...
/**
  ...
  public Port after(UserInfoInterface userInfo, ProcessData procData) {
	    ...
	    String sLayerSoaVar = getParsedAttribute(userInfo, "LayerSoa", procData);
	    ...
	    ProcessListVariable aplicacoesListVar = procData.getList(getAttribute("AplicacoesList"));
	      ...
	      try {	    	  
	    	  ...
	    	  asset.setLayerSoa(sLayerSoaVar);
	    	  ...
	    	  OERResponseData result = tester.runPasso(Config.getOERUsername(), Config.getOERPassword(), asset, 2);
