...
public class BlockRemoveFromArray extends Block {
  public Port portIn, portSuccess, portEmpty, portError;

  private static final String ARRAYS = "Arrays";
  private static final String INDEX = "Index";

  public BlockRemoveFromArray(int anFlowId, int id, int subflowblockid, String filename) {
  ...
  public Port after(UserInfoInterface userInfo, ProcessData procData) {
	    ...
	    if (StringUtilities.isEmpty(sArraysVar)) {
	      ...
	      outPort = portError;
	    } else if (StringUtilities.isEmpty(sIndexVar)) {
	      Logger.error(login, this, "after", procData.getSignature() + "empty value for Index attribute");
	      outPort = portError;
	    } else
	      try {
	    	...
	    	for(int i=0; i< arrayNames.length; i++){
	    		...
	    		listVar.removeItemAt(Integer.parseInt(sIndexVar));
	    	}    	
