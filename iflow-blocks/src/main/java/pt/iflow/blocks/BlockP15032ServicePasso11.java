...
public class BlockP15032ServicePasso11 extends BlockP15032OER {

  public BlockP15032ServicePasso11(int anFlowId, int id, int subflowblockid,
			String filename) {
  ...
  public Port after(UserInfoInterface userInfo, ProcessData procData) {
	    ...
	    List<OERDocument> documentList = new ArrayList<OERDocument>();
	      ...
	      try {	    	  
	    	  ...
	    	  OERResponseData result = tester.runPasso(Config.getOERUsername(), Config.getOERPassword(), asset, 11);
