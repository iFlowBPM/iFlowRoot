...
dados.put("action", response.encodeURL("AuthenticationBICServlet"));
dados.put("url", url);
...
hsSubst.put("isOverFailureLimit", LoginAttemptCounterController.isOverFailureLimit(config.getServletContext() , request, userInfo.getUtilizador()));
%>
