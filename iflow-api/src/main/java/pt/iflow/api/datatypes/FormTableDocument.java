...
public class FormTableDocument implements DataTypeInterface, ArrayTableProcessingCapable {

  public FormTableDocument() {
  }
  ...
  public String getDescription() {
    return Messages.getString("FormTableDocument.description"); //$NON-NLS-1$
  }

  public String getShortDescription() {
    return Messages.getString("FormTableDocument.short_description"); //$NON-NLS-1$
  }
  ...
  public String formatRow(UserInfoInterface userInfo, 
    ...
    return genLinkXml(val, docUrl, docFile);
  }
