...
public class Logger {
  ...
  public static void adminLog(LogLevel logLevel,
      String asManagerObject,
      String asMethodName,
      String asMessage,
      Throwable t) {
   ...
   * @see {@link #logFlowState(ProcessData, int, String, String, String, String)}
   */
  public static void logFlowState(UserInfoInterface userInfo, ProcessData procData, Block block, String message, Object caller,
      String method) {
  ...
  public static void adminDebug(String managerObject,
      String asMethodName,
      String asMessage) {
   ...
   *          log message to write
   */
  public static void infoJsp (String asUser,
			      String asJspPage,
			      String asMessage) {
  ...
  /**
   * Log a info message
   * @param asUser Requesting user name
   * @param asCallerObject Caller object name
   * @param asMethodName Name of caller method
   * @param asMessage log message to write
   */
  ...
  public static void adminInfo(String managerObject,
      String asMethodName,
      String asMessage) {
   ...
   * @param asUser Requesting user name
   * @param aoCallerObject Caller object
   * @param asMethodName Name of caller method
   * @param asMessage log message to write
   */
  public static void warning (String asUser,
			      Object aoCallerObject,
			      String asMethodName,
			      String asMessage) {
   ...
   * @param asUser Requesting user name
   * @param asJspPage jsp page name
   * @param asMessage log message to write
   */
  public static void warningJsp (String asUser,
				 String asJspPage,
				 String asMessage) {
  ...
  public static void adminWarning(String managerObject,
      String asMethodName,
      String asMessage) {
   ...
   * @param asMessage log message to write
   */
  public static void errorJsp (String asUser,
			       String asJspPage,
			       String asMessage) {
  ...
  public static void adminError(String managerObject,
      String asMethodName,
      String asMessage) {
   ...
   * @param asMessage log message to write
   */
  public static void fatal (String asUser,
			    Object aoCallerObject,
			    String asMethodName,
			    String asMessage) {
    String stmp = null;
   ...
   * @param asMessage log message to write
   */
  public static void fatalJsp (String asUser,
			       String asJspPage,
			       String asMessage) {
  ...
  public static void adminFatal(String managerObject,
      String asMethodName,
      String asMessage) {
   ...
   * @param asMessage log message to write
   */
  public static void trace (Object aoCallerObject,
			    String asMethodName,
			    String asMessage) {
    String stmp = null;
    if (aoCallerObject != null) {
   ...
   * @param asMessage log message to write
   */
  public static void traceJsp (String asJspPage,
			       String asMessage) {
   ...
   * @param asMessage log message to write
   */
  public static void trace (String asCallerObject,
			    String asMethodName,
			    String asMessage) {
  ...
  public static void adminTrace(String managerObject,
      String asMethodName,
      String asMessage) {
