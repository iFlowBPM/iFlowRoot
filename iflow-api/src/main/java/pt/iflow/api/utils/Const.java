...
public class Const {
	...
	public static final String sFLOW_PERCENTAGE_FORMAT = "FLOW_PERCENTAGE_FORMAT";
	public static String sFLOW_PERCENTAGE_FORMAT_DESC = "Formato para Percentagens";
  ...
  public static Boolean ENCRYPT_FILESYSTEM_DOCS = false;
	...
	public static synchronized void updateConstants() {
		...
		stmp = Setup.getProperty("DEFAULT_PERCENTAGE_FORMAT");
		if (StringUtils.isNotBlank(stmp)) {
			sDEF_PERCENTAGE_FORMAT = stmp;
		} else {
			sDEF_PERCENTAGE_FORMAT = "###0.000";
		}
		sFLOW_PERCENTAGE_FORMAT_DESC = "Formato para Percentagem (" + sDEF_PERCENTAGE_FORMAT + ")";

		stmp = Setup.getProperty("DEFAULT_CURRENCY_FORMAT");
		if (StringUtils.isNotBlank(stmp)) {
			sDEF_CURRENCY_FORMAT = stmp;
		} else {
			sDEF_CURRENCY_FORMAT = "#,##0.00";
		}
		sFLOW_FLOAT_FORMAT_DESC = "Formato para Números Decimais (" + sDEF_FLOAT_FORMAT + ")";

		stmp = Setup.getProperty("DEFAULT_NUMBER_LOCALE");
		if (StringUtils.isNotBlank(stmp)) {
			sDEF_NUMBER_LOCALE = stmp;
		} else {
